package forevtechnologies.alegriauiux.SendBird;
...
public class MainActivity extends FragmentActivity {
     ...
     */
    private static final String appId = "F3F9E488-7FC4-4B2C-9ABF-9BA655F11928"; /* Sample SendBird Application */
...
//        SendBird.notifyActivityPausedForOldAndroids();
    ...
    private void connect() {
        ...
        SendBird.connect(FirebaseInstanceId.getInstance().getId(), new SendBird.ConnectHandler() {
            @Override
            public void onConnected(User user, SendBirdException e) {
                ...
                SendBird.updateCurrentUserInfo(nickname, null, new SendBird.UserInfoUpdateHandler() {
                    ...
                    public void onUpdated(SendBirdException e) {
                        ...
                        editor.putString("user_id", FirebaseInstanceId.getInstance().getId());
