...
import forevtechnologies.alegriauiux.EvenCardUtils;
...
public class MainFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new CategoryCardsAdapter(getContext());
        adapter.addAll(EvenCardUtils.generateCategoryCards());

        adapter.setOnItemClickListener(new CategoryCardsAdapter.OnItemClickListener() {
            @Override
