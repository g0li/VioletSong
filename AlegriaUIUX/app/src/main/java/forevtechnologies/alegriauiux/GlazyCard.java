...
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_AUTO_TINT_MODE;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_CUT_COUNT;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_CUT_HEIGHT;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_IMAGE_CUT_TYPE;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_IMAGE_RES;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_LINE_SPACING_DP;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_SUB_TITLE_TEXT;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_SUB_TITLE_TEXT_COLOR;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_SUB_TITLE_TEXT_SIZE_DP;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_TEXT_MARGIN_DP;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_TINT_ALPHA;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_TINT_COLOR;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_TITLE_TEXT;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_TITLE_TEXT_COLOR;
import static forevtechnologies.alegriauiux.views.GlazyImageView.DEF_TITLE_TEXT_SIZE_DP;
