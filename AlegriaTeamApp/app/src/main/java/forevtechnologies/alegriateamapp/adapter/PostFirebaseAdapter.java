package forevtechnologies.alegriateamapp.adapter;
...
public class PostFirebaseAdapter extends FirebaseRecyclerAdapter<PostModel,PostFirebaseAdapter.MyChatViewHolder> {
    ...
    public PostFirebaseAdapter(DatabaseReference ref, String nameUser,ClickListenerChatFirebase mClickListenerChatFirebase) {
        super(PostModel.class, R.layout.item_message_left, PostFirebaseAdapter.MyChatViewHolder.class, ref);
        this.nameUser = nameUser;
